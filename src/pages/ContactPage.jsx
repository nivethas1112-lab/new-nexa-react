              ...
              <div className="card" style={{ boxShadow: 'var(--shadow-lg)', border: 'none', zIndex: '10' }}>
                ...
                <div style={{ display: 'flex', gap: '1rem', marginBottom: '2rem' }}>
                  ...
                  <div>
                    ...
                    <p style={{ color: 'var(--muted)', lineHeight: '1.6' }}>Camp Road Junction, Selaiyur,<br/>East Tambaram, Chennai<br/>India</p>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', gap: '1rem', marginBottom: '1rem' }}>
                  ...
                  <div>
                    ...
                    <p style={{ color: 'var(--muted)', lineHeight: '1.6' }}>+91 (555) 123-4567<br/>Mon-Fri from 9am to 6pm IST</p>
                  </div>
                </div>
              </div>
            </Reveal>
